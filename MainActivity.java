package com.example.sst_calender;
...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Google Calendar API의 호출 결과를 표시하는 TextView
     ...
     */
    //TODO : 여러 사람이 사용할 때에 API 접속이 어떤지 파악, Request Error 원인 파악
     ...
     */
    private String getCalendarID(String NaverHackday){
        ...
        do {
            ...
            for (CalendarListEntry calendarListEntry : items) {
                ...
                if ( calendarListEntry.getSummary().toString().equals(NaverHackday)) {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        /**
         * 2. NaverHackday 이름의 캘린더에서 10개의 이벤트를 가져와 리턴
         */
        private String getEvent() throws IOException {
            ...
            String calendarID = getCalendarID("NaverHackday");
            if ( calendarID == null ){

                return "캘린더를 먼저 생성하세요.";
            }

            // TODO : : EditText를 사용해 일정을 가져오고 싶은 시간 정하기
        ...
        /**
         * 1. 선택되어 있는 Google 계정에 새 캘린더를 추가한다.
         */
        private String createCalendar() throws IOException {

            String ids = getCalendarID("NaverHackday");
            ...
            // 캘린더의 제목 설정
            calendar.setSummary("NaverHackday");
            ...
            // 캘린더의 배경색을 초록색으로 표시  RGB
            calendarListEntry.setBackgroundColor("#008000");
        ...
        private String addEvent() {
            ...
            //TODO : EditText에서 값을 받아오도록 변경하기
            Event event = new Event()
                    .setSummary("Naver Calendar Test")
                    .setLocation("안산시")
                    .setDescription("나만 없어 고양이");
